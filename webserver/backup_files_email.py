...
def send_email_communication_error(error_type):
    ...
    msg["From"] = emailfrom
    msg["To"] = emailto
    msg["Subject"] = "CSC Communication Error: " + error_type +" at " + time.strftime("%Y-%m-%d %H:%M:%S")
    msg.preamble = "CSC Communication Error: " + error_type +" at " + time.strftime("%Y-%m-%d %H:%M:%S")
